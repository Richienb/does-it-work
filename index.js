var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;} : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};$.when(function () {
	...
	!function (window, document, undefined) {
		...
		function addTest(A, e) {
			...
			for (var t in A) {hasOwnProp(A, t) && addTest(t, A[t]);} else
			{
				A = A.toLowerCase();
				var n = A.split("."),
				r = Modernizr[n[0]];
		...
		function computedStyle(A, e, t) {
			...
			if ("getComputedStyle" in window) {
				...
				if (null !== n) t && (n = n.getPropertyValue(t));else
				if (r) {
		...
		Modernizr.addTest("urlparser", function () {
			...
			try {
				return (
					A = new URL("http://modernizr.com/"), "http://modernizr.com/" === A.href);
		...
		!function (A, e) {
			...
			A.html5 = h,
			s(e),
			"object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = h);
		...
		Modernizr.addTest("bgpositionshorthand", function () {
			...
			return (
				e.cssText = "background-position: " + t + ";", e.backgroundPosition === t);
		...
		Modernizr.addTest("cssgradients", function () {
			...
			r++) {
				...
				A = 0 === r ? "to " : "",
				n +=
				e + prefixes[r] + "linear-gradient(" + A + "left top, #9f9, white);";}
		...
		function () {
			try {
				return (
					"test" == createElement('<input name="test" />').getAttribute("name"));
		...
		Modernizr.addAsyncTest(function () {
			...
			try {
				...
				n.src =
				"data:audio/mpeg;base64,//MUxAAB6AXgAAAAAPP+c6nf//yi/6f3//MUxAMAAAIAAAjEcH//0fTX6C9Lf//0//MUxA4BeAIAAAAAAKX2/6zv//+IlR4f//MUxBMCMAH8AAAAABYWalVMQU1FMy45//MUxBUB0AH0AAAAADkuM1VVVVVVVVVV//MUxBgBUATowAAAAFVVVVVVVVVVVVVV";else
		...
		Modernizr.addAsyncTest(function () {
			...
			try {
				...
				window.OBlobBuilder,
				n =
				n || window.MozURL || window.webkitURL || window.MSURL || window.OURL);
				var r,
				o,
				i,
				a,
			...
			r(!1);else
			{
				...
				_i = function i() {
					return (
						...
						a = d.style.cssText, "" !== a ? r("blocked", d) : r(!0, d)) :
						r("blocked"),
						void n(s)) : (
						s = document.body || s,
						d = createElement("embed"),
		...
		Modernizr.addTest("mathml", function () {
			var A;
			return (
				testStyles("#modernizr{position:absolute;display:inline-block}", function (
				e)
				{
		...
		Modernizr.addTest("unicode", function () {
			...
			return (
				testStyles("#modernizr{font-family:Arial,sans;font-size:300em;}", function (
				n)
				{
		...
		e)
		{
			...
			r = n ?
			n.cssRules && n.cssRules[0] ? n.cssRules[0].cssText : n.cssText || "" :
			"",
		...
		function (A) {
			...
			"subpixelfont",
			window.getComputedStyle ?
			"44px" !== window.getComputedStyle(e, null).getPropertyValue("width") :
			!1);
		...
		Modernizr.inputtypes = function (A) {
			for (var e, t, n, r = A.length, o = "1)", i = 0; r > i; i++) {
				...
				n =
				t.getComputedStyle &&
				"textfield" !== t.getComputedStyle(inputElem, null).WebkitAppearance &&
		...
		Modernizr.addTest("localizednumber", function () {
			...
			return (
				A = "number" === r.type && 1.1 === r.valueAsNumber && r.checkValidity(),
				n.removeChild(e),
