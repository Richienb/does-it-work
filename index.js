function changeColumns(selected) {
    var elems = document.getElementsByTagName('ul');

    for (var i = 0; i < elems.length; i++) {
        console.log(elems[i])
        elems[i].style.columnCount = selected;
    }
}

// modernizr 3.6.0 (Custom Build) | MIT | https://goo.gl/ozJFrA
...
!(function(window, document, undefined) {
    ...
    Modernizr.addTest("todataurljpeg", function() {
        ...
        Modernizr.addTest(
            "inputformaction", !!("formAction" in createElement("input")), {
                aliases: ["input-formaction"]
            }
        ),
        Modernizr.addTest(
            "inputformenctype", !!("formEnctype" in createElement("input")), {
        ...
        Modernizr.addTest(
            "inputformtarget", !!("formtarget" in createElement("input")), {
